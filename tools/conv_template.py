...
combinations of the variables using (inside the comment portion of the
inner loop):

 :exclude: var1=value1, var2=value2, ...

This will exclude the pattern where var1 is value1 and var2 is value2
when the result is being generated.
...
def main(src, destdir):
    ...
    try:
        ...
        raise ValueError(f"In {src} loop at {e}") from None
...
if __name__ == "__main__":
    ...
    descr = 'NumPy template language. Convert <input>.src to <input>.'
